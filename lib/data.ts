...
export const PRIORITY_PROGRAMS: PriorityProgram[] = [
  {
    id: 'prog-1',
    title: 'Pariwisata Bahari & Religi',
    description: 'Revitalisasi pariwisata bahari PAI terpadu, pengembangan wisata religi cagar sejarah Alun-alun & Taman Pancasila serta sertifikasi pembinaan usaha kuliner legendaris Tegal.',
  ...
  },
  {
    ...
    description: 'Menjaring ekosistem wirausaha muda terdidik dalam program Akselerator AWMT, pembemainan berkelanjutan KNPI/OK, pembekalan Paskibraka serta inkubasi Youth Creative Hub.',
  ...
  },
  {
    ...
    description: 'Pembinaan atlet andalan daerah persiapan PORPROV & PON, standardisasi prasarana Stadion Yos Sudarso & GOR Wisanggeni serta transparansi sewa venue olahraga digital.',

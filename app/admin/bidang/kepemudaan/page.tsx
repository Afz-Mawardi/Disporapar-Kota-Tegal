    ...
    <div className="space-y-8 text-left animate-fade-in relative font-inter">
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm text-left">
        <div className="border-b border-slate-100 pb-4 mb-6">
          <h3 className="font-extrabold text-sm sm:text-base text-[#0E3B66] tracking-tight">Banner Promo Bawah Halaman Kepemudaan</h3>
          <p className="text-[10px] text-slate-400 mt-1 font-inter">Kustomisasi seksi promo khusus di bagian bawah sub-halaman Kepemudaan di website.</p>
        </div>

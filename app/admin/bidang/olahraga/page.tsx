...
export default function OlahragaAdminPage() {
  ...
  const bottomCard = bidangBottomCards.find(c => c.id === 'olahraga') || {
    id: 'olahraga',
  ...
  const filteredCards = olahragaCards.filter(item => {
    ...
    <div className="space-y-8 text-left animate-fade-in relative font-inter">
      ...
      <div className="sticky top-0 z-20 flex flex-col md:flex-row items-center justify-between gap-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-slate-200 shadow-md transition-all duration-300">
        ...
        >
          ...
          <span>Tambah Sarana Olahraga</span>
        </button>
      </div>
              ...
              {filteredCards.length > 0 ? (
                ...
                <tr>
                  <td colSpan={3} className="py-16 text-center text-slate-400">
                    ...
                    <p className="text-xs text-slate-400 mt-1 font-light">Coba tambahkan sarana olahraga baru.</p>
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm text-left">
        <div className="border-b border-slate-100 pb-4 mb-6">
          <h3 className="font-extrabold text-sm sm:text-base text-[#0E3B66] tracking-tight">Banner Promo Bawah Halaman Olahraga</h3>
          <p className="text-[10px] text-slate-400 mt-1 font-inter">Kustomisasi seksi promo khusus di bagian bawah sub-halaman Olahraga di website.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="Contoh: Sarana & Fasilitas Olahraga"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-accent text-slate-800 transition-all font-medium"
                placeholder="Contoh: Pusat Kegiatan Keolahragaan Kota Tegal"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-accent text-slate-800 transition-all font-medium"
                placeholder="Contoh: Pemberdayaan Atlet Daerah"
              />
            </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-150 overflow-hidden">
            <div className="p-6 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <h3 className="text-sm font-black text-[#0E3B66] uppercase tracking-wider font-mono">
                {modalType === 'add' ? 'Tambah Sarana Olahraga' : modalType === 'edit' ? 'Ubah Sarana Olahraga' : 'Konfirmasi Hapus'}
              </h3>
              <button
              ...
              {modalType === 'delete' ? (
                <div className="space-y-4">
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Apakah Anda yakin ingin menghapus data sarana olahraga <span className="font-bold text-slate-850">"{editingItem?.title}"</span>? Tindakan ini tidak dapat dibatalkan.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        placeholder="Contoh: Kios Teh Poci, Lapangan Indoor"
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-accent font-medium text-slate-800"
                      />
                    </div>
                  </div>
